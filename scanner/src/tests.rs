...
mod tests {
    ...
    fn test_parse_range_dash() {
        ...
        // We call the private fn via pub fn wrapper test
        let scanner = PortScanner::new(100, 8);
        // Just checking it doesn't panic; actual parsing tested below
        assert!(true);
    }
    ...
    fn test_scan_output_summary_ports() {
        use crate::models::{ScanOutput, PortResult, PortState};
        let ports = vec![
